...
- IA: proveedor intercambiable (`IAiProvider`), seleccionable por configuración (`AiProvider:Active`); adapters listos para Claude (Anthropic) y DeepSeek.
...
dotnet user-secrets set "AiProvider:Active" "Claude"          # o "DeepSeek"
